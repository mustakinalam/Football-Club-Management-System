...
<div id="demo" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img style="margin-left:20%;margin-right:18%;" src="images/pic2.png" alt="Home Kit" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img style="margin-left:20%;margin-right:18%;" src="images/pic3.png" alt="Christmas" width="1100" height="500">
    </div>
    <div class="carousel-item">
      <img style="margin-left:20%;margin-right:18%;" src="images/pic4.png" alt="Inside View" width="1100" height="500">
    </div>
  </div>
