...
<section id = "section1">
        <div class="title" style="color:white";> Shop Staff are sorted by Salary(£) (Ascending) </div>
			<form action = "search_shopp_staff.php" method="post">
		  ...
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
			  <div class="data-container">
				<?php
				  ...
				  $sql = "SELECT * FROM shop_staff ORDER BY salary DESC";
