...
<nav>
	...
	<li><b><a href="show_board_members_admin.php">BOARD MEMBERS</a></b></li>
...
<section id = "section1">
        <div class="title" style="color:white";> Board Members </div>
			...
			<div style="margin-left:10%;margin-right:10%;margin-top:50px;margin-bottom:50px;text-align:center;background:#b30000;">
				...
				<div class="col-md-4" style="color:white";><b> Member ID </b></div>
				<div class="col-md-4" style="color:white";><b> Name </b></div>
				<div class="col-md-4" style="color:white";><b> Joining Date </b></div>
				</div>
				  ...
				  if($queryResult > 0){
					while($row = mysqli_fetch_array($result)){
						...
						<div class="row" style="padding:5px;">
							...
							<div class="col-md-4" style="color:white";> <?php echo $row[1]; ?> </div>  
