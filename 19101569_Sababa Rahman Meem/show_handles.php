...
<section id = "section1">
        <div class="title" style="color:white";> Handles </div>
			<div style="margin-left:10%;margin-right:10%;margin-top:50px;margin-bottom:50px;text-align:center;background:#b30000;">
				<div class="row" style="padding:5px;"> 
				<div class="col-md-6" style="color:white";><b> Staff Name  </b></div>
				<div class="col-md-6" style="color:white";><b> Shop ID</b></div>
				</div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
			  <div class="data-container">
				<?php
				  require_once("DBconnect.php");
				  $sql = "SELECT SS.name, H.shop_id FROM shop_staff SS INNER JOIN handles H on SS.staff_id = H.staff_id";
