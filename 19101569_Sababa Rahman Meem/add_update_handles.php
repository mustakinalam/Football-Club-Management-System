...
<section id = "section1">
        <div class="title" style="color:white";> Club Shop Handling </div>

        
          <form action = "insert_handles.php" method="post">
		  ...
		  <br/>
		  <div style="text-align:center; font-size: 20px"><input type="submit" value="Add"></div><br/>
		  </form>
