...
<section id = "section1">
        <div class="title" style="color:white";> Board Members </div>
			<form action = "search.php" method="post">
				<input type="text" name="search" placeHolder="Search Board Members">
			...
			<div style="margin-left:10%;margin-right:10%;margin-top:50px;margin-bottom:50px;text-align:center;background:#b30000;">
				...
				<div class="col-md-5" style="color:white";><b> Name </b></div>
				<div class="col-md-5" style="color:white";><b> Joining Date </b></div>
				</div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
				  ...
				  if($queryResult > 0){
					while($row = mysqli_fetch_array($result)){
						...
						<div class="row" style="padding:5px;">
							...
							<div class="col-md-5" style="color:white";> <?php echo $row[2]; ?> </div>
						</div>
						<?php
					}
				  }
			...
			<div class="title" style="color:white;"> Sort Board Members by their joining date </div>
			<form action = "sort_board_members_asc.php" method="post">
			...
			<form action = "sort_board_members_desc.php" method="post">
