...
<!-- contents -->
    ...
    <section id = "section1">
        <div class="title" style="color:white";> DEFENDERS </div>
          ...
          <div class="row" style="padding:8px;">
            ...
            <div class="col-md-2" style="color:white";><b> Clean Sheets </b></div>
			<div class="col-md-2" style="color:white";><b> Tackles </b></div>
          </div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
		  <?php
		  require_once("DBconnect.php");
		  $sql = "SELECT D.Jersey_No,P.First_Name,P.Last_Name,D.CS,D.Tackles FROM player P INNER JOIN def D ON P.Jersey_No=D.Jersey_No;";
