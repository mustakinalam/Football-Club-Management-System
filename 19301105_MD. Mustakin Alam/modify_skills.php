...
<section id = "section1">
		<div class="title" style ="color:white";>Insert New Skill of a Player</div>
		...
		<div style="text-align:center; font-size: 20px">	Skills: <input type="text" name="skills"> </div> <br/>
		...
		<div class="title" style ="color:white";>Update Skill of a Player</div>
		<form action = "update_skills.php" method="post">
		
		<div style="text-align:center; font-size: 20px">	Set Skills: <input type="text" name="skills"> </div> <br/>
