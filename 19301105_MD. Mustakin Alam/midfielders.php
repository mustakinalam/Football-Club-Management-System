...
<!-- contents -->
    ...
    <section id = "section1">
        <div class="title" style="color:white";> MIDFIELDERS </div>
          ...
          <div class="row" style="padding:8px;">
            ...
            <div class="col-md-2" style="color:white";><b> Key Passes </b></div>
			<div class="col-md-2" style="color:white";><b> Assist </b></div>
          </div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
		  <?php
		  require_once("DBconnect.php");
		  $sql = "SELECT M.Jersey_No,P.First_Name,P.Last_Name,M.key_passes,M.Assist FROM player P INNER JOIN mid M ON P.Jersey_No=M.Jersey_No;";
