...
<!-- contents -->
    ...
    <section id = "section1">
        <div class="title" style="color:white";> Injury Update </div>
          ...
          <div class="row" style="padding:8px;">
            ...
            <div class="col-md-2" style="color:white";><b> Injury Date </b></div>
			<div class="col-md-2" style="color:white";><b> Injury Type </b></div>
			<div class="col-md-2" style="color:white";><b> Return Date </b></div>
          </div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
		  <?php
		  require_once("DBconnect.php");
		  $sql = "SELECT I.Jersey_No,P.First_Name,P.Last_Name,I.date,I.injury_type,I.return_date FROM player P INNER JOIN injury I ON P.Jersey_No=I.Jersey_No;";
		  ...
		  if(mysqli_num_rows($result) != 0){
			...
			<div class="row" style="padding:5px;">
				...
				<div class="col-md-2" style="color:white";> <?php echo $row[5]; ?> </div>
			</div>
