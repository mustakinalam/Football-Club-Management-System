...
<!-- contents -->
    ...
    <section id = "section1">
        <div class="title" style="color:white";> FORWARDS </div>
          ...
          <div class="row" style="padding:8px;">
			...
			<div class="col-md-2" style="color:white";><b> Goal </b></div>
          </div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
		  <?php
		  require_once("DBconnect.php");
		  $sql = "SELECT F.Jersey_No,P.First_Name,P.Last_Name,F.Assist,F.Goal FROM player P INNER JOIN forward F ON P.Jersey_No=F.Jersey_No;";
