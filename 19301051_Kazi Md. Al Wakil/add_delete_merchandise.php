...
<section id = "section1">
        <div class="title" style="color:white";> Add a new item to Merchandise </div>

        
          <form action = "insert_merchandise.php" method="post">
		  ...
		  <div class="title" style="color:white";> Delete Item From Merchandise </div>
          <form action = "delete_merchandise.php" method="post">
