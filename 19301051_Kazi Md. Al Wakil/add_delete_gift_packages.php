...
<section id = "section1">
        <div class="title" style="color:white";> Add a new item to Gift Packages </div>

        
          <form action = "insert_gift_packages.php" method="post">
		  ...
		  <div class="title" style="color:white";> Delete Item From Gift Packages </div>
          <form action = "delete_gift_packages.php" method="post">
