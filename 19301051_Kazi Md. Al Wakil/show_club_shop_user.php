...
<!-- contents -->
	...
	<section id = "section1">
		...
		<div class="title" style="color:white;"> Sort Items by Price(£) </div>
			<form action = "sort_items_asc.php" method="post">
			...
			<form action = "sort_items_desc.php" method="post">
