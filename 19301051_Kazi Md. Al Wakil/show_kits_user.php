...
<nav>
	<ul>
		...
		<li><b><a href="show_club_shop_user.php">CLUB SHOP</a></b></li>
...
<!-- contents -->
	...
	<section id = "section1">
        <div class="title" style="color:white";> KITS </div>
          ...
          <div class="row" style="padding:5px;">
            ...
            <div class="col-md-5" style="color:white";><b> Selling Item </b></div>
            <div class="col-md-3" style="color:white";><b> Price(£) </b></div>
          </div>
		  <!-- here we will write php codes to fetch data from database and will show in the rows of this table -->
		  <?php
		  require_once("DBconnect.php");
		  $sql = "SELECT K.shop_id, CS.selling_item, CS.quantity, CS.price FROM club_shop CS Right JOIN kits K on CS.shop_id = K.shop_id AND (CS.selling_item = 'Jersey' OR CS.selling_item = 'Track Suit')";
		  ...
		  if(mysqli_num_rows($result) != 0){
			...
			<div class="row" style="padding:5px;">
				...
				<div class="col-md-5" style="color:white";> <?php echo $row[1]; ?> </div>
	...
	<nav>
		<ul style="margin-left:38%;">
			<li><b><a href="show_kits_user.php" align="center">KITS</a></b></li>
			<li><b><a href="show_gift_packages_user.php" align="center">GIFT PACKAGES</a></b></li>
			<li><b><a href="show_merchandise_user.php" align="center">MERCHANDISE</a></b></li>
		</ul>
	</nav>
<footer>
	<h6 style="color:black" align="center";>Copyright &copy;2021-2022 , Manchester United</h6>
