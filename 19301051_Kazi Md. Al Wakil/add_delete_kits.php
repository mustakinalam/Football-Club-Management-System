...
<section id = "section1">
        <div class="title" style="color:white";> Add a new item to Kits </div>

        
          <form action = "insert_kits.php" method="post">
		  ...
		  <div class="title" style="color:white";> Delete Item From Kits </div>
          <form action = "delete_kits.php" method="post">
