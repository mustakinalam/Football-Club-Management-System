...
<section id = "section1">
        <div class="title" style="color:white";> Add a new item </div>
		  ...
		  <div style="text-align:center; font-size: 20px">Product ID: <input type="int" name="id"></div><br/>
		  <br/>
          ...
          <form action = "modify_club_shop.php" method="post">
			  ...
			  <div style="text-align:center; font-size: 20px">Set Product ID: <input type="int" name="id"></div><br/>
